...
relatedDocumentation = ['https://www.prh.fi/stc/forms/tavaramerkin_rekisterointihakemus.pdf']
attribute = "relatedDocumentation"
value = relatedDocumentation
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

language = ['http://publications.europa.eu/resource/authority/language/FIN', 'http://publications.europa.eu/resource/authority/language/SWE']
attribute = "language"
value = language
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))
