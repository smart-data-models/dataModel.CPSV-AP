...
dataModel = "PublicOrganization"
subject = "dataModel.CPSV-AP"
preferredLabel = "{'type': 'string', 'value': 'The Finnish Patent and Registration Office'}"
attribute = "preferredLabel"
value = preferredLabel
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

spatial = {'type': 'array', 'value': ['http://publications.europa.eu/resource/authority/atu/FIN']}
attribute = "spatial"
value = spatial
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))
