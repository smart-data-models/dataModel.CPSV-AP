...
class PublicServiceTypeEnum(Enum):
    Administrative_formality = 'Administrative formality'
    Public_Service = 'Public Service'
    Business_Lifecycle = 'Business Lifecycle'
    Business_Event = 'Business Event'
    Key_Business_Event = 'Key Business Event'
    Public_Service_Portfolio = 'Public Service Portfolio'
    Catalogue_of_Public_Services = 'Catalogue of Public Services'
...
class PublicService(BaseModel):
    ...
    hasCompetentAuthority: Optional[
        Union[
            constr(
                pattern=r'^[\\w\\-\\.\\{\\}\\$\\+\\*\\[\\]`|~^@!, :\\\\]+$',
                min_length=1,
    ...
    processingTime: Optional[AwareDatetime] = Field(
        None,
    ...
    publicServiceType: Optional[List[PublicServiceTypeEnum]] = Field(
        None,
    ...
    thematicArea: Optional[List[str]] = Field(
        None,
    ...
    type: Optional[Type6] = Field(None, description='It has to be PublicService')
