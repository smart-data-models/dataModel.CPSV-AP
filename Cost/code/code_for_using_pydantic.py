...
class Cost(BaseModel):
    ...
    description: Optional[str] = Field(
        None, description='This property represents a free text description of the Cost'
    )
    id: Optional[
        Union[
            constr(
    ...
    ifAccessedThrough: Optional[str] = Field(
        None,
    ...
    isDefinedBy: Optional[List[str]] = Field(
        None,
    ...
    type: Optional[Type6] = Field(None, description='It has to be Cost')
