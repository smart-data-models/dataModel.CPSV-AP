...
class CriterionRequirement(BaseModel):
    ...
    criterionReqType: Optional[List[str]] = Field(
        None,
    ...
    type: Optional[Type6] = Field(None, description='It has to be CriterionRequirement')
